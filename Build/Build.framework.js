...
// end include: preamble.js
  ...
  var EasyLocalLLM_BridgeState = {activeControllers:{},callback:{gameObjectName:null,methodName:null},runtimeScriptLoadPromise:null};
  
  function EasyLocalLLM_ToString(ptr) {
      return UTF8ToString(ptr);
    }
  function _EasyLocalLLM_Llama_Abort(requestIdPtr) {
  ...
  function EasyLocalLLM_GetBridge() {
      return typeof window !== "undefined" ? window.EasyLocalLLMLlamaBridge : null;
    }
  
  function EasyLocalLLM_Dispatch(eventPayload) {
  ...
  function _EasyLocalLLM_Llama_Generate(requestJsonPtr) {
  ...
  function EasyLocalLLM_GetRuntimeScriptUrl() {
  ...
  function EasyLocalLLM_LoadScript(url) {
  ...
  function EasyLocalLLM_EnsureBridgeRuntime() {
      var bridge = EasyLocalLLM_GetBridge();
  ...
  function _EasyLocalLLM_Llama_Init(gameObjectNamePtr, callbackMethodNamePtr, configJsonPtr) {
  ...
  function _EasyLocalLLM_Llama_ResetSession(sessionIdPtr) {
...
var wasmImports = {
  "EasyLocalLLM_Llama_Abort": _EasyLocalLLM_Llama_Abort,
  "EasyLocalLLM_Llama_Generate": _EasyLocalLLM_Llama_Generate,
  "EasyLocalLLM_Llama_Init": _EasyLocalLLM_Llama_Init,
  "EasyLocalLLM_Llama_ResetSession": _EasyLocalLLM_Llama_ResetSession,
...
var unexportedSymbols = [
  ...
  'EasyLocalLLM_ToString',
  'EasyLocalLLM_GetBridge',
  'EasyLocalLLM_GetRuntimeScriptUrl',
  'EasyLocalLLM_LoadScript',
  'EasyLocalLLM_EnsureBridgeRuntime',
  'EasyLocalLLM_Dispatch',
];
